			...
			<div class="jumbotron" style="padding-top: 20px;">
				...
				<form method="post" action="joinAction.jsp">
					...
					<div class="form-group" style="text-align: center;">
						<div class="btn-group" data-toggle="buttons"> <%// 버튼 2개 이상일때 buttons %>
							<label class="btn btn-primary active">
								<input type="radio" name="userGender" value="남자" autocapitalize="off" checked="checked">남자
							</label>
							<label class="btn btn-primary"> <%// 부트스트랩 버튼 클래스 %>	
								<input type="radio" name="userGender" value="여자" autocapitalize="off" checked="checked">여자
							</label>
						</div>
					</div>
